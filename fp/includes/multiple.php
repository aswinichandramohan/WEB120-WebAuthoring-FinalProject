 ...
 *
 * @package nmCAPTCHA2
 * @author Aswini <aswinichandramohan@gmail.com>
 * @version 1.01 2015/11/17
 * @link http://www.aswinichandramohan.com/
...
#EDIT THE FOLLOWING:
$toAddress = "aswinichandramohan@gmail.com";  //place your/your client's email address here
$toName = "Aswini Chandramohan"; //place your client's name here
$website = "Unniversal Innovations Client Form";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thanks for your request. </br> Your Comments Have Been Received!</h2>
...
?>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Products" tabindex="40" /> Products <br />
			<input type="checkbox" name="Interested_In[]" value="Supplier" /> Supplier <br />
			<input type="checkbox" name="Interested_In[]" value="Service" /> Service <br />
			<input type="checkbox" name="Interested_In[]" value="Sales" /> Sales <br />
